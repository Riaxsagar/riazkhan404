...
def pkgs():
        love("\033[1;91m«-----------------\033[1;96mRiazkhan\033[1;91m-----------------»")
        ...
        love("\033[1;91m«--------𒈞░R░I░A░Z░K░░H░A░N𒈞--------»")
        love("\033[1;95mRiaz 2nd Tool Start ComingSoon New Update»")
        love("\033[1;96m «-----------------\033[1;92mRiazkhan\033[1;96m--------------»")
        time.sleep(0.3)
...
##### LOGO #####
logo = """
\033[1;96mPAK HACKERS░░░\033[1;92m░░░RIAZKHAN╗░░WEBDEVELOPER╗░AND╗░░A\033[1;91mETICALHACKER╗
\033[1;96mYT╔══RK╗Bk║░\033[1;92m░░░░WEBHACKER╔══PAK╗ANONAYMOUS╔══YOUTUBE╗CHANNEL║\033[1;91m░https://youtube.com/channel/UCPOWtzNan9ff-E0RI66Wu2A╔╝
...
\033[1;92mVISIT╔█OUR█╔YT║█CHANNEL█\033[1;91mB4║█BA
...
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ 03188214452
\033[1;96m«-----------------\033[1;91mRiazkhan\033[1;96m-----------------»"""
...
def menu():
    ...
    print(logo)
    os.system('clear')
    os.system('echo  RIAZ░░░░░░KHAN░░PAKISTANI░ETICAL░░HACKER | lolcat -a -F 0.1')
    os.system('echo  RIAZ░░░░░KHAN██WEB██DEVELOPER░██ | lolcat -a -F 0.1')
    os.system('echo  WHATSAPP░░░░░03188214452░░FOR THIS SCRIPT░ | lolcat -a -F 0.1')
    os.system('echo  CONTACT  ░░░░░ME ON WHATSAPP░░RIAZ CYBER HACKER░ | lolcat -a -F 0.1')
    ...
    os.system('echo  SHABIR BALOCH WHATSAPP = 03188214452 | lolcat -a -F 0.1')
    os.system('echo  VISIT OUR YOUTUBE CHANNEL https://youtube.com/channel/UCPOWtzNan9ff-E0RI66Wu2A | lolcat -a -F 0.1')
    ...
    os.system('echo ----------------RUAZ KHAN-----------------| lolcat')
    os.system('echo  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  RIAZ KHAN| lolcat --animate')
    os.system('echo  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  RIAZHACKER| lolcat --animate')
    os.system('echo  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈| lolcat')
    os.system('echo  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp| lolcat --animate')
    os.system('echo  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈03188214452| lolcat --animate')
    os.system('echo -----------------RIAZKHANI KHAN----------------| lolcat --animate')
    ...
    time.sleep(0.0005)
    os.system('echo         Type python2 riazkhan404.py| lolcat --animate')
    os.system('echo -----------------RIAZ KHAN----------------| lolcat --animate')
    time.sleep(0.0005)
    ...
    time.sleep(0.0005)
    os.system('echo [W]  RIAZKHAN  MASTER WhatsApp Group-------- Tool----● | lolcat --animate')
    time.sleep(0.0005)
